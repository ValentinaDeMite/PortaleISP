...
class ApiRest {
  ...
  async logout(token) {
    const url =
      // this.env === "LOCAL"
      //   ? `${this.url}/logout?redirectto=https://hpf.mvsitaly.com`
      //   : `${this.url}/auth/logout?redirectto=https://hpf.mvsitaly.com`;
      this.env === "LOCAL"
        ? `${this.url}/logout?redirectto=https://portale-isp.mvsitaly.com`
        : `${this.url}/auth/logout?redirectto=https://portale-isp.mvsitaly.com`;
    try {
